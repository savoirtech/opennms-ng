...
public class SnmpCollector implements ServiceCollector {
     ...
     * </ul>
     */
    static String SNMP_STORAGE_KEY = "SnmpCollector.snmpStorage";
    ...
    public CollectionSet collect(CollectionAgent agent, EventProxy eventProxy, Map<String, Object> parameters) throws CollectionException {
        try {
            ...
            try {
                 ...
                 */
                if (System.getProperty("SnmpCollector.forceRescan", "false").equalsIgnoreCase("true")
                 ...
                 * @see org.opennms.netmgt.config.collector.CollectionSet#visit(BasePersister visitor)
                 */
