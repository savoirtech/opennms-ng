...
public class DefaultCollectionAgent extends InetNetworkInterface implements CollectionAgent {
     ...
     */
    public static CollectionAgent create(final Integer ifaceId, final OnmsIpInterfaceDao ifaceDao, final PlatformTransactionManager transMgr) {
    ...
    private DefaultCollectionAgent(final CollectionAgentService agentService) {
        ...
        if (Boolean.getBoolean("DefaultCollectionAgent.loadSnmpDataOnInit")) {
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#isStoreByForeignSource()
     */
    /**
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getHostAddress()
     */
    /**
     * <p>getHostAddress</p>
     *
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#setSavedIfCount(int)
     */
    /** {@inheritDoc} */
    @Override
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getSavedIfCount()
     */
    /**
     * <p>getSavedIfCount</p>
     *
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getForeignSource()
     */
    /**
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getForeignId()
     */
    /**
     * <p>getForeignId</p>
     *
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getStorageDir()
     */
    /**
     * <p>getStorageDir</p>
     *
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getSysObjectId()
     */
    /**
     * <p>getSysObjectId</p>
     *
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#validateAgent()
     */
    /**
     * <p>validateAgent</p>
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getAgentConfig()
     */
    /**
     * <p>getAgentConfig</p>
     *
    ...
    /* (non-Javadoc)
     * @see CollectionAgent#getSnmpInterfaceInfo(IfResourceType)
     */
    /** {@inheritDoc} */
    @Override
