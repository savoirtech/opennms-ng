...
public class OnmsSnmpCollection {
     ...
     *
     * @param agent a {@link CollectionAgent} object.
    ...
    public OnmsSnmpCollection(CollectionAgent agent, ServiceParameters params, DataCollectionConfigDao config) {
        ...
        if (Boolean.getBoolean("OnmsSnmpCollection.loadResourceTypesInInit")) {
     ...
     *
     * @param current a {@link String} object.
     * @return a {@link String} object.
     */
     ...
     *
     * @param agent a {@link CollectionAgent} object.
     * @return a {@link SnmpCollectionSet} object.
     */
     ...
     *
     * @param agent a {@link CollectionAgent} object.
     * @param resourceType a {@link ResourceType} object.
     ...
     *
     * @param agent a {@link CollectionAgent} object.
     * @param instanceName a {@link String} object.
     ...
     *
     * @param agent a {@link CollectionAgent} object.
     * @return a {@link NodeResourceType} object.
     */
     ...
     *
     * @param agent a {@link CollectionAgent} object.
     * @return a {@link IfResourceType} object.
     */
     ...
     *
     * @param agent a {@link CollectionAgent} object.
     * @return a {@link IfAliasResourceType} object.
     */
