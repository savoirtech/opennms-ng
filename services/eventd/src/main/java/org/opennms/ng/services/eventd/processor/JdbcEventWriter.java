...
public final class JdbcEventWriter extends AbstractJdbcPersister implements EventProcessor, InitializingBean {
    ...
    private void insertEvent(final Header eventHeader, final Event event, final Connection connection) throws SQLException {
        ...
        try {
            ...
            // eventCorrelation
            set(insStmt, 20, (event.getCorrelation() != null) ? Correlation.format(event.getCorrelation(), EVENT_CORRELATION_FIELD_SIZE) : null);
            ...
            // eventForward
            set(insStmt, 29, (event.getForwardCount() > 0) ? Forward.format(event.getForward(), EVENT_FORWARD_FIELD_SIZE) : null);
