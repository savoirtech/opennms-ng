...
public class EventCreator implements TrapProcessor {
    ...
    public EventCreator(TrapdIpMgr trapdIpMgr) {
        ...
        eventBuilder = new EventBuilder(null, "trapd");
    }

    /** {@inheritDoc} */
    @Override
    public void setCommunity(String community) {
        eventBuilder.setCommunity(community);
    }

    /** {@inheritDoc} */
    @Override
    public void setTimeStamp(long timeStamp) {
        eventBuilder.setSnmpTimeStamp(timeStamp);
    }

    /** {@inheritDoc} */
    @Override
    public void setVersion(String version) {
        eventBuilder.setSnmpVersion(version);
    }

    private void setGeneric(int generic) {
        eventBuilder.setGeneric(generic);
    }

    private void setSpecific(int specific) {
        eventBuilder.setSpecific(specific);
    }

    private void setEnterpriseId(String enterpriseId) {
        eventBuilder.setEnterpriseId(enterpriseId);
    }

    /** {@inheritDoc} */
    @Override
    public void setAgentAddress(InetAddress agentAddress) {
        eventBuilder.setHost(InetAddressUtils.toIpAddrString(agentAddress));
    }
    ...
    public void setTrapAddress(InetAddress trapAddress) {
        ...
        long nodeId = trapdIpMgr.getNodeId(str(trapAddress));
        if (nodeId != -1) {
