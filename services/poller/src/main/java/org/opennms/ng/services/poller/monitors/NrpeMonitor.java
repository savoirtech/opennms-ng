...
import org.opennms.ng.services.poller.nrpe.NrpeException;
...
final public class NrpeMonitor extends AbstractServiceMonitor {
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.monitors.NrpeMonitor.class);
