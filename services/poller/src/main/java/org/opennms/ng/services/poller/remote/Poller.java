...
public class Poller implements InitializingBean, PollObserver, ConfigurationChangedListener, PropertyChangeListener {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.remote.Poller.class);
	 ...
	 *
	 * @param pollerFrontEnd a {@link PollerFrontEnd} object.
	 */
	...
	private void assertNotNull(Object propertyValue, String propertyName) {
		Assert.state(propertyValue != null, propertyName+" must be set for instances of "+ org.opennms.ng.services.poller.remote.Poller.class);
	}
