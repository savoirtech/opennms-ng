...
public class MailTransportParameters {
    ...
    public static final String KEY = org.opennms.ng.services.poller.monitors.MailTransportParameters.class.getName();
    ...
    static synchronized org.opennms.ng.services.poller.monitors.MailTransportParameters get(Map<String,Object> parameterMap) {
        org.opennms.ng.services.poller.monitors.MailTransportParameters parms = (org.opennms.ng.services.poller.monitors.MailTransportParameters)parameterMap.get(KEY);
        if (parms == null) {
            parms = new org.opennms.ng.services.poller.monitors.MailTransportParameters(parameterMap);
	...
	public int getRetries() {
		return getIntParm("retry", org.opennms.ng.services.poller.monitors.MailTransportParameters.DEFAULT_RETRY);
	}
	...
	public int getTimeout() {
		return getIntParm("timeout", org.opennms.ng.services.poller.monitors.MailTransportParameters.DEFAULT_TIMEOUT);
	}
