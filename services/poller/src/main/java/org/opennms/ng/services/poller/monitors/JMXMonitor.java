...
public abstract class JMXMonitor extends AbstractServiceMonitor {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.monitors.JMXMonitor.class);
    ...
    /* (non-Javadoc)
     * @see org.opennms.ng.services.poller.monitors.ServiceMonitor#poll(org.opennms.ng.services.poller.monitors.NetworkInterface, java.util.Map, org.opennms.netmgt.config.poller.Package)
     */
    /** {@inheritDoc} */
    @Override
