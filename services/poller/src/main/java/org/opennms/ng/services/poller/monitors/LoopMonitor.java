...
public class LoopMonitor implements ServiceMonitor {
    ...
    /* (non-Javadoc)
     * @see org.opennms.ng.services.poller.ServiceMonitor#initialize(org.opennms.netmgt.config.PollerConfig, java.util.Map)
     */
    /** {@inheritDoc} */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.ng.services.poller.ServiceMonitor#release()
     */
    /**
     * <p>release</p>
     */
    ...
    /* (non-Javadoc)
     * @see org.opennms.ng.services.poller.ServiceMonitor#initialize(org.opennms.netmgt.poller.MonitoredService)
     */
    /**
     * <p>initialize</p>
     *
    ...
    /* (non-Javadoc)
     * @see org.opennms.ng.services.poller.ServiceMonitor#release(org.opennms.netmgt.poller.MonitoredService)
     */
    /** {@inheritDoc} */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.opennms.ng.services.poller.ServiceMonitor#poll(org.opennms.netmgt.poller.MonitoredService, java.util.Map, org.opennms.netmgt.config.poller.Package)
     */
    /** {@inheritDoc} */
    @Override
