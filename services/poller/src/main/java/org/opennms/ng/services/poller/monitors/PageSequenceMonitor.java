...
public class PageSequenceMonitor extends AbstractServiceMonitor {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.monitors.PageSequenceMonitor.class);
    ...
    public static class PageSequenceMonitorParameters {
        ...
        public int getRetries() {
            return getIntParm("retry", org.opennms.ng.services.poller.monitors.PageSequenceMonitor.DEFAULT_RETRY);
        }

        public int getTimeout() {
            return getIntParm("timeout", org.opennms.ng.services.poller.monitors.PageSequenceMonitor.DEFAULT_TIMEOUT);
        }
