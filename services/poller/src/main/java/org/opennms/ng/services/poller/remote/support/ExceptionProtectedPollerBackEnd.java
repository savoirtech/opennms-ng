...
import org.opennms.ng.services.poller.remote.PollerConfiguration;
...
public class ExceptionProtectedPollerBackEnd implements PollerBackEnd {
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.remote.support.ExceptionProtectedPollerBackEnd.class);
     ...
     * <p>setDelegate</p>
     *
     * @param delegate a {@link org.opennms.ng.services.poller.remote.PollerBackEnd} object.
     */
