...
public class DefaultQueryManager implements QueryManager {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.DefaultQueryManager.class);
    ...
    public boolean activeServiceExists(String whichEvent, int nodeId, String ipAddr, String serviceName) {
        ...
        try {
            ...
            stmt = dbConn.prepareStatement(org.opennms.ng.services.poller.DefaultQueryManager.SQL_COUNT_IFSERVICE_STATUS);
            d.watch(stmt);
    ...
    public List<Integer> getActiveServiceIdsForInterface(String ipaddr) throws SQLException {
        ...
        try {
            ...
            stmt = dbConn.prepareStatement(org.opennms.ng.services.poller.DefaultQueryManager.SQL_FETCH_IFSERVICES_TO_POLL);
            d.watch(stmt);
    ...
    public int getServiceCountForInterface(String ipaddr) throws SQLException {
        ...
        try {
            ...
            stmt = dbConn.prepareStatement(org.opennms.ng.services.poller.DefaultQueryManager.SQL_COUNT_IFSERVICES_TO_POLL);
            d.watch(stmt);
    ...
    public List<IfKey> getInterfacesWithService(String svcName) throws SQLException {
        ...
        PreparedStatement stmt = dbConn.prepareStatement(org.opennms.ng.services.poller.DefaultQueryManager.SQL_RETRIEVE_INTERFACES);
        d.watch(stmt);
    ...
    public Date getServiceLostDate(int nodeId, String ipAddr, String svcName, int serviceId) {
        ...
        try {
            ...
            outagesQuery = dbConn.prepareStatement(org.opennms.ng.services.poller.DefaultQueryManager.SQL_RETRIEVE_SERVICE_STATUS);
    ...
    public void reparentOutages(String ipAddr, int oldNodeId, int newNodeId) {
        try {
            ...
            LOG.error(" Error reparenting outage for "+oldNodeId+":"+ipAddr+" to "+newNodeId, e);
        }
