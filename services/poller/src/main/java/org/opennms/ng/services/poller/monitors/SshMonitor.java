...
final public class SshMonitor extends AbstractServiceMonitor {
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.monitors.SshMonitor.class);
     ...
     * {@inheritDoc}
     *
     * Poll an {@link java.net.InetAddress} for SSH availability.
     *
     ...
     * @see #poll(java.net.InetAddress, java.util.Map)
     */
    @Override
