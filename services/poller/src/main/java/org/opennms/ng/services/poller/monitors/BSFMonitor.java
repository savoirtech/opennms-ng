...
public class BSFMonitor extends AbstractServiceMonitor {
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.monitors.BSFMonitor.class);
    ...
    public PollStatus poll(MonitoredService svc, Map<String,Object> map) {
        ...
        try {
            ...
            if(file.exists() && file.canRead()){   
                    ...
                    bsfManager.declareBean("bsf_monitor", this, org.opennms.ng.services.poller.monitors.BSFMonitor.class);
