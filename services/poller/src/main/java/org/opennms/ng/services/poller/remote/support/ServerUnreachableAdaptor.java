...
public class ServerUnreachableAdaptor implements PollerBackEnd {
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.remote.support.ServerUnreachableAdaptor.class);
     ...
     *
     * @param remoteBackEnd a {@link org.opennms.ng.services.poller.remote.PollerBackEnd} object.
     */
