...
final public class TrivialTimeMonitor extends AbstractServiceMonitor {
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.poller.monitors.TrivialTimeMonitor.class);
     ...
     * @param skew a {@link Number} object.
