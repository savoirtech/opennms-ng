...
package org.opennms.ng.services.translator;
...
import org.opennms.ng.services.translatorconfig.EventTranslatorConfig;
...
public class EventTranslator implements EventListener {
     ...
     */
    public EventTranslator getInstance() {
        return s_instance;
    }
    ...
    private boolean isReloadConfigEvent(Event event) {
        ...
        if (EventConstants.RELOAD_DAEMON_CONFIG_UEI.equals(event.getUei())) {
            ...
            for (Parm parm : parmCollection) {
                if (EventConstants.PARM_DAEMON_NAME.equals(parm.getParmName()) && "Translator".equalsIgnoreCase(parm.getValue().getContent())) {
                    isTarget = true;
                    break;
                }
            }
