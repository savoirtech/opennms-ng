 ...
 * @see org.opennms.ng.services.capsd.snmp.IpAddrTable
...
public final class IpAddrTableEntry extends SnmpStore {
    ...
    public InetAddress getIpAdEntAddr() {
        return getIPAddress(org.opennms.ng.services.capsd.snmp.IpAddrTableEntry.IP_ADDR_ENT_ADDR);
    }
    ...
    public Integer getIpAdEntIfIndex() {
        return getInt32(org.opennms.ng.services.capsd.snmp.IpAddrTableEntry.IP_ADDR_IF_INDEX);
    }
