...
public class FtpResponse {
     ...
     */
    public static org.opennms.ng.services.capsd.plugins.FtpResponse readResponse(BufferedReader in) throws IOException {
        int code;
        ...
        return new org.opennms.ng.services.capsd.plugins.FtpResponse(code, response.toArray(new String[response.size()]));
    }
}
