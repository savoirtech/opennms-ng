...
import org.opennms.ng.services.poller.nrpe.CheckNrpe;
import org.opennms.ng.services.poller.nrpe.NrpePacket;
...
public final class NrpePlugin extends AbstractPlugin {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.capsd.plugins.NrpePlugin.class);
     ...
     * @param bannerResult Banner line generated by the remote host must contain this
     *                     text.
        ...
        for (int attempts = 0;attempts <= retries && !isAServer;attempts++) {
            ...
            try {
                ...
                */
                ...
                isAServer = false;
                LOG.warn("NrpePlugin: An undeclared throwable exception was caught connecting to host " + InetAddressUtils.str(host) + " on port "
                    + port, t);
            } finally {
                try {
                    if (socket != null) {
     ...
     * @param hostAddress a {@link String} object.
