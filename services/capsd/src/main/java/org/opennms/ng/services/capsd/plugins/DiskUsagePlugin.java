...
public final class DiskUsagePlugin extends AbstractPlugin {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.opennms.ng.services.capsd.plugins.DiskUsagePlugin.class);
    /**
    ...
    public boolean isProtocolSupported(InetAddress address, Map<String, Object> qualifiers) {
        ...
        try {
            ...
            if (qualifiers != null) {
                ...
                if (qualifiers.get("match-type") != null) {
                    ...
                    if (matchTypeStr.equalsIgnoreCase("exact")) {
                        ...
                        if (matchTypeStr.equalsIgnoreCase("startswith")) {
                            matchType = MATCH_TYPE_STARTSWITH;
                        } else {
                            if (matchTypeStr.equalsIgnoreCase("endswith")) {
                                matchType = MATCH_TYPE_ENDSWITH;
                            } else {
                                if (matchTypeStr.equalsIgnoreCase("regex")) {
            ...
            for (Map.Entry<SnmpInstId, SnmpValue> e : descrResults.entrySet()) {
                LOG.debug("capsd: SNMPwalk succeeded, addr=" + InetAddressUtils.str(address) + " oid=" + hrStorageDescrSnmpObject + " instance=" + e
                    .getKey() + " value=" + e.getValue());
