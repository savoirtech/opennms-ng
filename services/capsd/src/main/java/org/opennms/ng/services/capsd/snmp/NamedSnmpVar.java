...
public final class NamedSnmpVar implements Collectable {
     ...
     * <p>getTrackersFor</p>
     *
     * @param columns an array of {@link org.opennms.ng.services.capsd.snmp.NamedSnmpVar} objects.
     * @return an array of {@link org.opennms.netmgt.snmp.CollectionTracker} objects.
     */
    public static CollectionTracker[] getTrackersFor(final org.opennms.ng.services.capsd.snmp.NamedSnmpVar[] columns) {
        if (columns == null) {
