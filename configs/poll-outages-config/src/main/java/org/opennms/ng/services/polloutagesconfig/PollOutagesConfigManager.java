...
import org.opennms.ng.services.pollerconfig.BasicScheduleUtils;
...
abstract public class PollOutagesConfigManager extends AbstractJaxbConfigDao<Outages, Outages> implements PollOutagesConfig {
     ...
     */
    public org.opennms.netmgt.config.poller.Time[] getOutageTimes(final String name) {
        final Outage out = getOutage(name);
        if (out == null) {
            return null;
        }
     ...
     * <p>removeOutage</p>
     *
     * @param outageName a {@link String} object.
     */
     ...
     * <p>getEndOfOutage</p>
     *
     * @param outName a {@link String} object.
     * @return a {@link java.util.Calendar} object.
     */
     ...
     * </p>
     *
     * @param lnodeid the nodeid to be looked up
