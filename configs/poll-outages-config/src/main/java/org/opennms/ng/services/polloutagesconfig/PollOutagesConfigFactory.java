...
public final class PollOutagesConfigFactory extends PollOutagesConfigManager {
     ...
     */
    public PollOutagesConfigFactory(final String configFile) {
    ...
    public static synchronized void init() throws IOException, MarshalException, ValidationException {
        ...
        m_singleton = new PollOutagesConfigFactory(new FileSystemResource(ConfigFileConstants.getFile(
            ConfigFileConstants.POLL_OUTAGES_CONFIG_FILE_NAME)));
     ...
     * </p>
     *
     * @param instance a {@link org.opennms.netmgt.config.PollOutagesConfigFactory}
     *                 object.
     */
