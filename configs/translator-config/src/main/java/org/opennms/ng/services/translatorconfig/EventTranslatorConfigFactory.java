...
package org.opennms.ng.services.translatorconfig;
 ...
 */
public  class EventTranslatorConfigFactory implements EventTranslatorConfig {
     ...
     */
    public  void init() throws IOException, MarshalException, ValidationException, ClassNotFoundException, SQLException, PropertyVetoException  {
        if (m_loaded) {
      ...
      //  DataSourceFactory.init();
        ...
        m_singleton = new EventTranslatorConfigFactory(cfgFile.getPath(), dataSource);
     ...
     * @throws java.beans.PropertyVetoException if any.
     */
    public  void reload() throws IOException, MarshalException, ValidationException, ClassNotFoundException, SQLException, PropertyVetoException {
        m_singleton = null;
        m_loaded = false;
	 ...
	 * <p>setInstance</p>
	 *
	 * @param singleton a {@link EventTranslatorConfig} object.
	 */
