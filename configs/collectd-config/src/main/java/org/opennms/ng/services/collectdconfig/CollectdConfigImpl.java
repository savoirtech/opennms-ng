...
public class CollectdConfigImpl implements CollectdConfig {
     ...
     */
    protected CollectdConfigImpl(CollectdConfiguration config, String localServer, boolean verifyServer) {
        m_config = config;
