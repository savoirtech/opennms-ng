...
CREATE TABLE ipInterface (id INTEGER NOT NULL, ipAddr VARBINARY(20), ipHostName VARCHAR(256), ipLastCapsdPoll TIMESTAMP, isManaged VARCHAR(1), DTYPE VARCHAR(255), isSnmpPrimary INTEGER, nodeId INTEGER, snmpInterfaceId INTEGER, PRIMARY KEY (id));
