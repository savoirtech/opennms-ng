...
abstract public class InetAddressUtils {
	...
	private static final Logger LOG = LoggerFactory.getLogger(org.opennms.core.utils.InetAddressUtils.class);
	...
	public static String incr(final String address) throws UnknownHostException {
        return org.opennms.core.utils.InetAddressUtils.toIpAddrString(incr(org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(address)));
    }
    ...
    public static String decr(final String address) throws UnknownHostException {
        return org.opennms.core.utils.InetAddressUtils.toIpAddrString(decr(org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(address)));
    }
     ...
     * <p>getInetAddress</p>
     *
     * @param dottedNotation a {@link String} object.
     * @return a {@link java.net.InetAddress} object.
     */
	...
	public static boolean isInetAddressInRange(final byte[] laddr, final String beginString, final String endString) {
        final byte[] begin = org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(beginString);
        final byte[] end = org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(endString);
	...
	public static boolean isInetAddressInRange(final String addrString, final String beginString, final String endString) {
        final byte[] addr = org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(addrString);
        final byte[] begin = org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(beginString);
	...
	public static boolean isInetAddressInRange(final String ipAddr, final byte[] begin, final byte[] end) {
		return isInetAddressInRange(org.opennms.core.utils.InetAddressUtils.toIpAddrBytes(ipAddr), begin, end);
	}
